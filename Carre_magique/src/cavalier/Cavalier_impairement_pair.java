...
public static int[][] ordreImpairementPair (int n) throws IOException  { //création de méthode pour les carrés d'ordre impair
	 ...
	 String nomFic = "carre_" + n + ".txt"; // Création du fichier contenant le tableau
		...
		// Impression du tableau
			...
			hFic.println("La somme magique est " + (p*p*p+p)/2*2);
			hFic.close();
		System.out.println("fin écriture, programme terminé.");
